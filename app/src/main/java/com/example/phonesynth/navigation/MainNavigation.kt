...
import com.example.phonesynth.viewModel.AppViewModelFactory
import com.example.phonesynth.screen.InstEnsembleScreen
    ...
    NavHost(navController = navController, startDestination = "menu") {
        ...
        composable("inst") {
            Column {
                ...
                InstScreen(viewModel(factory = AppViewModelFactory(application)))
            }
        }
        composable("instEnsemble") {
            Column {
                MakeTopMenuBackTo {
                    navController.navigate("menu")
                }

                InstEnsembleScreen(viewModel(factory = AppViewModelFactory(application)))
            }
        }
        composable("sensorView") {
            Column {
                ...
                SensorViewScreen(viewModel(factory = AppViewModelFactory(application)))
            }
        }
    }
}